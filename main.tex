...
Fingerprint vectors, wich encode important properties of atomic environments, have been used to study atomic structures for some time. Here we suggest a method to use these fingerprints, to classify the type of atom present in carbon-nitrate crystals. For this, we calculated fingerprints of known carbon-nitrate structures where the only physical parameters used were the covalent radii and the orbital eigenenergies of the respective atom species. The fingerprints were then used to calculate a maximum volume simplex where the corners of this simplex were then compared to unknown carbon-nitrate structures to classify its constituent atoms. We achieved a good classification accuracy comparable to supervised learning algorithms.
\end{abstract}
